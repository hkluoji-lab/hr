...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  LoginIdentity: 'login session identity is owned by packages/host/web-login/README.md',
  WorkbenchClientCreated: 'Remote client-master write result is owned by packages/workbench/workbench/README.md',
  WorkbenchClientCreate: 'Remote client-master write payload is owned by packages/workbench/workbench/README.md',
  WorkbenchClientList: 'Remote client-master read is owned by packages/workbench/workbench/README.md',
  WorkbenchCreditGrant: 'Remote grant result is owned by packages/workbench/workbench/README.md',
  WorkbenchDelivery: 'Remote delivery row is owned by packages/workbench/workbench/README.md',
  WorkbenchDeliveryCreate: 'Remote delivery write payload is owned by packages/workbench/workbench/README.md',
  WorkbenchDeliveryList: 'Remote delivery ledger read is owned by packages/workbench/workbench/README.md',
  WorkbenchDeliveryStatus: 'Remote delivery lifecycle state is owned by packages/workbench/workbench/README.md',
  WorkbenchFollowUpCreate: 'Remote follow-up logging payload is owned by packages/workbench/workbench/README.md',
  WorkbenchFollowUpList: 'Remote follow-up-center read is owned by packages/workbench/workbench/README.md',
  WorkbenchLedger: 'Remote ledger page is owned by packages/workbench/workbench/README.md',
  WorkbenchObligation: 'Remote obligation row is owned by packages/workbench/workbench/README.md',
  WorkbenchObligationCreate: 'Remote obligation write payload is owned by packages/workbench/workbench/README.md',
  WorkbenchObligationList: 'Remote obligation ledger read is owned by packages/workbench/workbench/README.md',
  WorkbenchObligationStatus: 'Remote obligation lifecycle state is owned by packages/workbench/workbench/README.md',
  WorkbenchReminderLogged: 'Remote follow-up logging result is owned by packages/workbench/workbench/README.md',
  WorkbenchSchedule: 'Remote schedule read is owned by packages/workbench/workbench/README.md',
