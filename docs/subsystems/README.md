...
| [workbench.md](workbench.md) | the host workbench half: the persisted credits domain (one balance plus an append-only ledger) and the roster-vs-live-session team-status Remote |
