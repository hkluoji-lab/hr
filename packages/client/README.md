...
| [`ui-workbench/`](ui-workbench/README.md) | Hero workbench dashboard, task-hall/assistant/team/report pages, and the session-scoped deliverables, progress, credits, and team-status tabs | — |
